...
TARGET  = build
OBJS	  = \
	adc.rel ch559.rel flash.rel hid.rel hid_guncon3.rel hid_keyboard.rel \
	hid_switch.rel hid_xbox.rel led.rel pwm1.rel serial.rel timer3.rel uart1.rel \
	usb_device.rel usb_host.rel
